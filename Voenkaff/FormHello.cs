...
namespace Voenkaff
{
    public partial class FormHello : Form
    {
        ...
        public Dictionary<Panel, FormChooseTestName> ListMarksAndName { get; set; } =
            new Dictionary<Panel, FormChooseTestName> { };
        ...
        public void Redistribution(List<Panel> panelList)
        {
            ...
            buttonCreateTest.Location =
                new System.Drawing.Point(585, 81 + 70 * panelList.Count + panelMain.AutoScrollPosition.Y);
        }
        ...
        private void testCurrentDownload(object sender, EventArgs e)
        {
            ...
            new PictureCreator().CreatePictures(ListTests[parentPanel],
        ...
        private void testCurrentMarks(object sender, EventArgs e)
        {
            ...
            Visible = false;
            CheckBox fuck =
                (CheckBox) (ListMarksAndName[parentPanel].Controls[0].Controls.Find("checkBoxIsFirstOpen", false)[0]);
            fuck.Checked = false;
        ...
        private void comboBoxCourseFilter_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboBox.SelectedItem != null)
            {
                ...
                panelMain.Controls.Find("buttonCreateTest", true)[0].Location =
                    new Point(585, 81 + 70 * listPanelWithFilter.Count);
            }
        }
        ...
        public void buttonFilterOff_Click(object sender, EventArgs e)
        {
            ...
            panelMain.Controls.Find("buttonCreateTest", true)[0].Location =
                new Point(585, 81 + 70 * ListPanelsTestsOnPanel.Count);
            Redistribution(ListPanelsTestsOnPanel);
        }
    }
}