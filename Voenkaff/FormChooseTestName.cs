...
namespace Voenkaff
{
    public partial class FormChooseTestName : Form
    {
        ...
        private void buttonNext_checkNullMarks(object sender, System.EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(textBoxMark5.Text) && !string.IsNullOrEmpty(textBoxMark4.Text) && !string.IsNullOrEmpty(textBoxMark3.Text))
            {
                if (Int32.TryParse(textBoxMark5.Text, out fake) && Int32.TryParse(textBoxMark4.Text, out fake) &&
                    Int32.TryParse(textBoxMark3.Text, out fake))
                {
                    if (Int32.Parse(textBoxMark5.Text) < 0 || Int32.Parse(textBoxMark5.Text) > 100 ||
                        Int32.Parse(textBoxMark4.Text) < 0 || Int32.Parse(textBoxMark4.Text) > 100 ||
                        Int32.Parse(textBoxMark3.Text) < 0 || Int32.Parse(textBoxMark3.Text) > 100)
                    {
                        buttonNext.Enabled = false;
                    ...
                    if (Int32.Parse(textBoxMark5.Text) > Int32.Parse(textBoxMark4.Text) &&
                        Int32.Parse(textBoxMark4.Text) > Int32.Parse(textBoxMark3.Text))
                    {
                        markIsGrow = true;
            ...
            if (textBoxUserChooseTestName.Text == null || textBoxUserChooseTestName.Text == "" ||
        ...
        private void buttonNext_Click(object sender, EventArgs e)
        {
            ...
            if (checkBoxIsFirstOpen.Checked)
            {
                if (!testNameAlreadyExist)
                {
                    ...
                    Test peremTest = new Test(_formHello, textBoxUserChooseTestName.Text,
                        _formHello.TestNameAndMarks[textBoxUserChooseTestName.Text],
